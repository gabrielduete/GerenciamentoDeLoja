...
def infoScreen():  # informações do sistema
    ...
    info = Label(info_screen, text="Informações:", bg='#6763fd',
                 font="Arial 18", fg='white').place(x=150, y=10)
    more_info = Label(info_screen, text="Sistema de Gerenciamento de Assistência Técnica",
                      bg='#6763fd', font="Arial 15").place(x=0, y=48)
    more_info2 = Label(info_screen, text="Desenvolvido por:",
                       bg='#6763fd', font="Arial 15", fg='white').place(x=141, y=80)
    more_info3 = Label(info_screen, text="Gabriel Monteiro Duete",
                       bg='#6763fd', font="Arial 14").place(x=115, y=110)
    more_info4 = Label(info_screen, text="Rafael Candido Lacerda Carvalho",
                       bg='#6763fd', font="Arial 14").place(x=70, y=140)
    more_info5 = Label(info_screen, text="Samuel Vitor de França Veras",
                       bg='#6763fd', font="Arial 14").place(x=90, y=170)
    more_info6 = Label(info_screen, text="2° Semestre - IFCE CRATO",
                       bg='#6763fd', font="Arial 14", fg='white').place(x=100, y=200)

    def ok_info():
        info_screen.destroy()
    ok = Button(info_screen, text="Ok", width=8, bd=3,
                command=ok_info).place(x=190, y=235)
